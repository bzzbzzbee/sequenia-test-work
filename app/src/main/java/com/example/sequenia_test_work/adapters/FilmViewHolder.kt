...
class FilmViewHolder(
    ...
    private val firstFilmLayout: ConstraintLayout = itemView.findViewById(R.id.layout_first_film)
    ...
    private val secondFilmLayout: ConstraintLayout = itemView.findViewById(R.id.layout_second_film)
